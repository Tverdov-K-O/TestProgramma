...
// класс представл€ющий собою один из возможных ответов на вопрос(Question)
class Answer {
...
// класс представл€ющий собою один из возможных вопросов в тесте(Test)
class Question {
...
// класс представл€ющий собою один из возможных тестов в разделе(Section)
class Test {
...
// класс представл€ющий собою категорию,раздел
class Section {
...
// класс представл€ющий собою результат прохождени€ теста
class Result {
...
// функци€ дл€ хешировани€ логина и парол€
hash<string> hasher;

// класс представл€ющий собою пользовател€ (данные,результаты)
class User {
...
{
    system("cls");
    cout << "   -¬аши персональные данные-   " << endl;
    cout << "--------------------------------" << endl;
    cout << "‘»ќ    : " << fullName << endl;
    cout << "јдрес  : " << address << endl;
    cout << "“елефон: " << phoneNumber << endl;
    system("pause");
}
